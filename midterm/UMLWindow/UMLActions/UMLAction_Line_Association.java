...
public class UMLAction_Line_Association extends UMLAction_Line {
    public UMLAction_Line_Association(ImageIcon ii1, ImageIcon ii2, TheWindow tw, UMLObjectsContainer umlocter_,
            int ssIdx_) {
    ...
    protected void setIIName() {
        this.iiDescription = "AssociationLine";
    }
    ...
    public void setUMLLine(UMLObject umlo1, UMLObject umlo2) {
        ...
        umlo1.umlol[umlo1.lastSelectedSide] = new UMLObject_Line(umlo2,
                umlo2.lastSelectedSide, umlo1.umll_sa[0]);
    }
}
